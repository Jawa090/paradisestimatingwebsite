  ...
  const serviceCategories = [
    {
      ...
      services: constructionManagementServices.slice(0, 4)
    },
    {
      title: 'Quantity Takeoff',
      services: quantityTakeoffServices.slice(0, 4)
    },
    {
      title: 'Cost Estimation',
      services: costEstimationServices.slice(0, 4)
    },
    {
      title: 'Specialized',
      services: specializedServices.slice(0, 4)
    }
  ];
            ...
            <div>
              ...
              <ul className="space-y-5 text-base">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-300">(718)719 6171</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-6 h-6 mr-3 text-gold flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
