          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800">
                Doors, Windows & Glazing Takeoffs
              </span>
              <br />
              <span className="text-gray-800">Precise Measurements, Accurate Estimates</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
              Expert quantity takeoffs for all types of doors, windows, and glazing systems — maximize accuracy and win more bids.
            </p>
        ...
        <Container>
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive takeoff services for all door, window, and glazing systems
            </motion.p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Accurate measurements for all openings and systems"
              },
              {
            ...
            {[
              {
                ...
                description: "Deep expertise in doors, windows, and glazing systems"
              },
              {
...
export default DoorsWindowsGlazing;