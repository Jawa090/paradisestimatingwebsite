...
import { allServices } from '@/data/newServices.tsx';
...
const EstimateDownload = () => {
  ...
  // Brief summary/theory of services (first 3 from allServices)
  const serviceSummary = allServices.slice(0, 3).map((service) => (
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="pt-32 pb-10">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-navy mb-6">Request a Project Estimate</h1>
          <div className="h-1 w-20 bg-gold mx-auto mb-6"></div>
          <p className="text-gray-600 text-lg mb-8">
            Fill out the form below to request a personalized estimate for your project. Our team will review your information and get back to you promptly.
          </p>
        </div>
      </section>
      <section className="py-8">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg mb-8 md:mb-0 animate-fade-in">
              <h2 className="text-2xl font-bold text-navy mb-4">Our Services</h2>
              <div className="grid gap-4">{serviceSummary}</div>
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-navy mb-2">Why Choose Us?</h3>
                <ul className="list-disc list-inside text-gray-600 text-sm space-y-2">
                  <li>Accurate, detailed estimates for all project types</li>
                  <li>Fast turnaround and responsive support</li>
                  <li>Experienced, professional estimators</li>
                  <li>Confidential and secure file handling</li>
                </ul>
              </div>
            </div>
            {/* Form Column */}
            <div className="bg-white rounded-lg p-8 shadow-lg animate-fade-in">
              <h2 className="text-xl font-bold text-navy mb-6">Estimate Request Form</h2>
              <Form {...form}>
